...
#define __MOTOR_READ_LEFT_ENCODER()		(-(short)HAL_LPTIM_ReadCounter(MOTOR_LEFT_ENCODER_TIM))
#define __MOTOR_CLEAR_LEFT_ENCODER()	__HAL_LPTIM_RESET_COUNTER(MOTOR_LEFT_ENCODER_TIM)
#define __MOTOR_READ_RIGHT_ENCODER()	(short)HAL_LPTIM_ReadCounter(MOTOR_RIGHT_ENCODER_TIM)
#define __MOTOR_CLEAR_RIGHT_ENCODER()	__HAL_LPTIM_RESET_COUNTER(MOTOR_RIGHT_ENCODER_TIM)

#define __MOTOR_LEFT_PWMA1(n)		__HAL_TIM_SET_COMPARE(&htim16,TIM_CHANNEL_1,n) //PF6
#define __MOTOR_LEFT_PWMA2(n)		__HAL_TIM_SET_COMPARE(&htim17,TIM_CHANNEL_1,n) //PF7
#define __MOTOR_RIGHT_PWMB1(n)		__HAL_TIM_SET_COMPARE(&htim13,TIM_CHANNEL_1,n) //PF8
#define __MOTOR_RIGHT_PWMB2(n)		__HAL_TIM_SET_COMPARE(&htim14,TIM_CHANNEL_1,n) //PF9
